...
export const Ban = ({ leader, currentBan }: BanLeaderProps) => {
    ...
    return (
        <div
            ref={containerRef}
            className={`h-28 w-28 flex-wrap rounded-full sm:h-12 sm:w-12 md:h-16 md:w-16  lg:h-20 lg:w-20 xl:h-28 xl:w-28 ${leader?.src ? "" : "border-2  border-border bg-background-dark"
